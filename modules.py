...
#Here we declare model called Users and defined its field with it’s properties.
...
#After import SQLAlchemy and bind it to our flask app, we can declare our models.
#Here we declare model called "DailyExpences" and defined its field with it’s properties.
...
#Here we define that our JSON response will have three keys(Date, Ration and Vegetables).
#Also we defined "details" as instance of details_schema, and "all_details" as instances of list of details.#  
